...
| dimp-auth-migrate   |      | `migrate/auth-migrate-job.yaml`    |                  | `ghcr.io/1spyral/dimp-auth-migrate`   |                                                            |
...
| dimp-server-migrate |      | `migrate/server-migrate-job.yaml`  |                  | `ghcr.io/1spyral/dimp-server-migrate` |                                                            |
